...
features_Train, target_Train = undersample.fit_resample(features_Train, target_Train)
...
import pickle
with open('/local/home/henrikm/Fakenews_Classification/T_Test/Khan_C_LSTM_under_accuracies.pkl','wb') as f:
