...
features_Pad, target_Train_Resampled = undersample.fit_resample(features_Pad, target_Train)
num_Norm_Train, target_Train = undersample.fit_resample(num_Norm_Train, target_Train)
...
x = concatenate([lstm_out, cnn_out])
...
print(predictions[0])
import pickle
with open('/local/home/henrikm/Fakenews_Classification/T_Test/CNN_LSTM_under_proba.pkl','wb') as f:
