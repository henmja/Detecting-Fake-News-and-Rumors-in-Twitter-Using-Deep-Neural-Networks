...
import numpy as np
try:
    BiLSTM_proba = pd.read_pickle('/local/home/henrikm/Fakenews_Classification/T_Test/BiLSTM_proba.pkl')
    BiLSTM_proba = np.mean(BiLSTM_proba,axis=1)
except FileNotFoundError:
    pass
try:
    C_LSTM_proba = pd.read_pickle('/local/home/henrikm/Fakenews_Classification/T_Test/C-LSTM_proba.pkl')
    C_LSTM_proba = np.mean(C_LSTM_proba,axis=1)
except FileNotFoundError:
    pass
try:
    C_LSTM_Func_proba = pd.read_pickle('/local/home/henrikm/Fakenews_Classification/T_Test/CNN_LSTM_proba.pkl') 
    C_LSTM_Func_proba = np.mean(C_LSTM_Func_proba,axis=1)
except FileNotFoundError:
    pass
try:
    CNN_proba = pd.read_pickle('/local/home/henrikm/Fakenews_Classification/T_Test/CNN_proba.pkl')
    CNN_proba = np.mean(CNN_proba,axis=1) 
except FileNotFoundError:
    pass
try:
    Khan_LSTM_proba = pd.read_pickle('/local/home/henrikm/Fakenews_Classification/T_Test/Khan_BiLSTM_proba.pkl')
    Khan_LSTM_proba = np.mean(Khan_LSTM_proba,axis=1)
except FileNotFoundError:
    pass
try:
    Khan_C_LSTM_proba = pd.read_pickle('/local/home/henrikm/Fakenews_Classification/T_Test/Khan_C_LSTM_proba.pkl')
