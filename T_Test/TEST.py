...
C_LSTM_Accuracies = pd.read_pickle('C-LSTM_accuracies.pkl')
C_LSTM_Func_Accuracies = pd.read_pickle('C_LSTM_accuracies.pkl') 
CNN_Accuracies = pd.read_pickle('CNN_accuracies.pkl')
Khan_LSTM_Accuracies = pd.read_pickle('Khan_BiLSTM_accuracies.pkl')
Khan_C_LSTM_Accuracies = pd.read_pickle('Khan_C_LSTM_accuracies.pkl')
