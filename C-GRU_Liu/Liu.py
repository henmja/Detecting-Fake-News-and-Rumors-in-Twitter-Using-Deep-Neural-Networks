...
from keras.layers import Input, Embedding, LSTM, Dense, merge, concatenate, GRU, Conv1D, Flatten
...
model.fit([time_series_Mat,num_Norm_Train], [target_Train, target_Train], nb_epoch=1, batch_size=32)
...
print('predictions shape')
print(predictions.shape)
matrix = metrics.confusion_matrix(target_Val.argmax(axis=1), y_pred[0].argmax(axis=1))
